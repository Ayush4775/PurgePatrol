...
csv_file = "/Users/ayushchaudhary/Desktop/PurgePatrol/Data/employee_worktimes.csv"  # Replace with your CSV file path
...
table_name = "employee_worktimes"  # You can name the table as needed
columns = ", ".join(
    [f"{col} TEXT" for col in data.columns]
)  # Assuming all columns are TEXT
